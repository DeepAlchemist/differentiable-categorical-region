...
class CommonMetricPrinter(EventWriter):
    ...
    def write(self):
        ...
        self.logger.info(
            " {eta} iter: {iter} {losses} {time} {data_time} lr: {lr}".format(
                ...
                time="t: {:.4f}".format(iter_time) if iter_time is not None else "",
                data_time="d_t: {:.4f}".format(data_time) if data_time is not None else "",
                lr=lr,
