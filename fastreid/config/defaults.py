...
# Last Change:  2022-07-12 10:46:11
# -----------------------------------------------------------------------------
...
_C.MODEL.NUM_PART = 3
_C.MODEL.BRANCH = ['']
_C.MODEL.GLOBAL_ATTN = False
_C.MODEL.LOSSES.OAP = CN()
_C.MODEL.LOSSES.OAP.TAU = 0.1
_C.MODEL.LOSSES.OAP.SCALE = 1.0
_C.MODEL.BACKBONE.WITH_CSA = False # channel-spatial attention
_C.MODEL.BACKBONE.WITH_NLKEY = False # keys of non-local block
_C.MODEL.LOSSES.OCCLUDED = CN()
_C.MODEL.LOSSES.OCCLUDED.ENABLED = False
