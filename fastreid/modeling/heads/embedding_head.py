...
class EmbeddingHead(nn.Module):
    def __init__(self, cfg):
        ...
        elif cls_type == 'oimCircleSoftmax':
            self.classifier = OIMCircleSoftmax(cfg, feat_dim, num_classes)
        elif cls_type == 'oimArcSoftmax':
            self.classifier = OIMArcSoftmax(cfg, feat_dim, num_classes)
        else:
